...
PROJECT_ID="cs308-477215"
INSTANCE_CONN_NAME="cs308-477215:europe-west9:db"
PORT=5432
...
#FOR TEST RUN:
#psql "host=127.0.0.1 port=5432 dbname=308db user=postgres password=308database sslmode=disable"