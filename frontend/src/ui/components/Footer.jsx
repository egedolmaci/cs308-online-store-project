const Footer = () => {
  return (
    <footer className="relative mt-20 bg-gradient-to-br from-sand/50 via-sage/30 to-sand/50 backdrop-blur-xl">
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-2 space-y-4">
            <h3 className="text-3xl font-bold text-gray-900">Fashion Store</h3>
            <p className="text-gray-600 leading-relaxed max-w-md">
              Curating timeless pieces that define your unique style. Quality
              craftsmanship meets modern design.
            </p>
            <div className="flex gap-4 pt-4">
              <button className="w-10 h-10 rounded-full bg-white hover:bg-gray-900 hover:text-white transition-all duration-300 flex items-center justify-center shadow-md">
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
                  viewBox="0 0 24 24"
          ...
          <div>
            <h4 className="font-bold text-gray-900 mb-4 text-lg">Shop</h4>
